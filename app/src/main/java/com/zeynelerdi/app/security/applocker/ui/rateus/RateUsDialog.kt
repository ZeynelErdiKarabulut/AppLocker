...
import com.zeynelerdi.app.security.applocker.databinding.DialogRateUsBinding
...
class RateUsDialog : BaseBottomSheetDialog<RateUsViewModel>() {
    ...
    private fun onRatePositiveClicked() {
        ...
        activity?.let { startActivity(Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=com.zeynelerdi.app.security.applocker"))) }
        dismiss()
    }
