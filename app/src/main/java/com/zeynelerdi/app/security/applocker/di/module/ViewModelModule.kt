...
import com.zeynelerdi.app.security.applocker.data.database.callblocker.addtoblacklist.AddToBlackListViewModel
import com.zeynelerdi.app.security.applocker.di.ViewModelFactory
import com.zeynelerdi.app.security.applocker.di.key.ViewModelKey
import com.zeynelerdi.app.security.applocker.ui.background.BackgroundsActivityViewModel
import com.zeynelerdi.app.security.applocker.ui.background.BackgroundsFragmentViewModel
import com.zeynelerdi.app.security.applocker.ui.browser.BrowserViewModel
import com.zeynelerdi.app.security.applocker.ui.browser.bookmarks.BookmarksViewModel
import com.zeynelerdi.app.security.applocker.ui.callblocker.CallBlockerViewModel
import com.zeynelerdi.app.security.applocker.ui.callblocker.blacklist.BlackListFragment
import com.zeynelerdi.app.security.applocker.ui.callblocker.blacklist.BlackListViewModel
import com.zeynelerdi.app.security.applocker.ui.callblocker.blacklist.delete.BlackListItemDeleteViewModel
import com.zeynelerdi.app.security.applocker.ui.callblocker.log.CallLogViewModel
import com.zeynelerdi.app.security.applocker.ui.intruders.IntrudersPhotosViewModel
import com.zeynelerdi.app.security.applocker.ui.main.MainViewModel
import com.zeynelerdi.app.security.applocker.ui.newpattern.CreateNewPatternViewModel
import com.zeynelerdi.app.security.applocker.ui.overlay.activity.OverlayValidationViewModel
import com.zeynelerdi.app.security.applocker.ui.permissiondialog.UsageAccessPermissionViewModel
import com.zeynelerdi.app.security.applocker.ui.permissions.PermissionsViewModel
import com.zeynelerdi.app.security.applocker.ui.policydialog.PrivacyPolicyViewModel
import com.zeynelerdi.app.security.applocker.ui.rateus.RateUsViewModel
import com.zeynelerdi.app.security.applocker.ui.security.SecurityViewModel
import com.zeynelerdi.app.security.applocker.ui.settings.SettingsViewModel
import com.zeynelerdi.app.security.applocker.ui.vault.VaultViewModel
import com.zeynelerdi.app.security.applocker.ui.vault.addingvaultdialog.AddToVaultViewModel
import com.zeynelerdi.app.security.applocker.ui.vault.removingvaultdialog.RemoveFromVaultViewModel
import com.zeynelerdi.app.security.applocker.ui.vault.vaultlist.VaultListViewModel
import dagger.Binds
